...
<head>
  ...
  <script src='<?=base_url()?>scripts/main.js' type='text/javascript'></script>
...
<div id='outer-wrap-header'>
  <div id='inner-wrap-header'>
    <div id='header'>
      <div id='login-menu'><?=login_menu_new()?></div>
      <div id='banner'>
        <a href='<?=base_url()?>'><img id='site-logo' src="<?=base_url()?><?=$logo?>" alt='logo' width="<?=$logo_width?>" height="<?=$logo_height?>" /></a>
...
<div id='outer-wrap-flash'>
  <div id='inner-wrap-flash'>
    <div id='flash'><?=getHTMLForNav("navbar")?></div>
  </div>
</div>
